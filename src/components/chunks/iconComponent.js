    ...
    if (type === 'logo-typo') {
        ...
        return (
            <svg width="24" height="216" fill="none"><path d="M3 69l6-6m-2-5a7 7 0 1014 0 7 7 0 00-14 0z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                ...
                <path d="M3 205h8m-8 0v7a1 1 0 001 1h7m-8-8v-7a1 1 0 011-1h6a1 1 0 011 1v7m0 0v8m0-8h7a1 1 0 011 1v6a1 1 0 01-1 1h-7m4-11h6a1 1 0 001-1v-6a1 1 0 00-1-1h-6a1 1 0 00-1 1v6a1 1 0 001 1z" stroke="currentColor" strokeWidth="1.5"></path>
            </svg>
        );
    } else if (type === 'vscode-bottom') {
        return (
            <svg width="24" height="72" fill="none">
                ...
                <path d="M15 60a3 3 0 11-6 0 3 3 0 016 0zM5.121 17.804A13.936 13.936 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>
        );
    } else if (type === 'danger') {
        return (
            <svg width="24" height="24" fill="none" className="flex-none text-yellow-400">
                ...
                <path d="M12.5 16a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z" stroke="currentColor"></path>
            </svg>
        );
    }
}